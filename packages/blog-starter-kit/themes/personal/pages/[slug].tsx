...
const Post = ({ publication, post }: PostProps) => {
	...
	return (
		<>
			...
			<h1 className="text-4xl leading-tight tracking-tight text-sky-950 dark:text-white">
				{post.title}
			</h1>
			<div className="text-sky-950 dark:text-neutral-400">
...
export default function PostOrPage(props: Props) {
	...
	return (
		<AppProvider publication={publication} post={maybePost}>
			<Layout>
				<Container className="mx-auto flex max-w-3xl flex-col items-stretch gap-10 px-5 py-10 text-white font-mono">
					<PersonalHeader />
